...
// Client-side configurations (copied straight from ClientConfig)
...
export default function webpackConfigFactory(buildOptions) {
  ...
  let webpackConfig = {
    ...
    plugins: removeNil([
      ...
      ifProdClient(
        () =>
          // Extremely Important: 'ejs-loader' is required
          new HtmlWebpackPlugin({
            ...
            // Extremely Important: Made our client side configuration available in browser
            window: {
