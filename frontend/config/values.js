...
const values = {
  ...
  clientDevServerPort: EnvVars.number('CLIENT_DEV_PORT', 1338),
  ...
  htmlPage: {
    titleTemplate: 'Bosen - %s',
    defaultTitle: 'Bosen',
    description: ['Bosen is a content management system.'].join(' '),
  },
  ...
  core: {
    backend: {
      protocol: EnvVars.string('CORE_BACKEND_PROTOCOL', 'http://'),
      host: EnvVars.string('CORE_BACKEND_HOST', '127.0.0.1'),
      port: EnvVars.number('CORE_BACKEND_PORT', 8080),
      basePath: EnvVars.string('CORE_BACKEND_BASEPATH', '/'),
    },
  },
};
